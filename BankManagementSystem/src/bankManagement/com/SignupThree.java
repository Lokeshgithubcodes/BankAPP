...
public class SignupThree extends JFrame implements ActionListener {
	...
	public SignupThree(String formno) {
		...
		JLabel number= new JLabel("XXXX-XXXX-XXXX-6420");
		...
		c2=new JCheckBox("Internet Baking");
		c2.setBackground(Color.WHITE);
		c2.setFont(new Font("Raleway", Font.BOLD, 16));
		c2.setBounds(350, 500, 200, 30);
		add(c2);
		
		c3=new JCheckBox("Mobile Bankig");
		c3.setBackground(Color.WHITE);
		c3.setFont(new Font("Raleway", Font.BOLD, 16));
		c3.setBounds(100, 550, 200, 30);
		add(c3);
		
		c4=new JCheckBox("Email & MSG Alerts");
		...
		c7=new JCheckBox("Above detail are correct");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==submit) {
			...
			if(c1.isSelected()) {
				...
				facility=facility+" Email & msg alerts";
